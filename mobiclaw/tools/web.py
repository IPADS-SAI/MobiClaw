...
def _fetch_url_text(url: str) -> tuple[str, int] | tuple[None, int]:
    ...
    max_bytes = int(os.environ.get("MOBICLAW_WEB_MAX_BYTES", "200000"))

    resp = requests.get(url, timeout=timeout_s, headers={"User-Agent": "MobiClaw/0.1"})
