...
mobi = importlib.import_module("mobiclaw.tools.mobi")
shell = importlib.import_module("mobiclaw.tools.shell")
file_tools = importlib.import_module("mobiclaw.tools.file")
web = importlib.import_module("mobiclaw.tools.web")
