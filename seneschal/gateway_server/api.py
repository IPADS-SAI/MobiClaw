...
def register_routes(app) -> None:
    ...
    async def gateway_console() -> HTMLResponse:
        ...
        if not webui_index.exists():
            return HTMLResponse(content="<h1>Gateway Console Not Found</h1><p>missing seneschal/webui/gateway_console.html</p>", status_code=404)
    ...
    async def gateway_chat() -> HTMLResponse:
        ...
        if not webui_chat.exists():
            return HTMLResponse(content="<h1>Gateway Chat Not Found</h1><p>missing seneschal/webui/gateway_chat.html</p>", status_code=404)
    ...
    async def gateway_settings() -> HTMLResponse:
        ...
        if not webui_settings.exists():
            return HTMLResponse(content="<h1>Gateway Settings Not Found</h1><p>missing seneschal/webui/gateway_settings.html</p>", status_code=404)
