...
```bash
python app.py --agent-task "把美伊战争整理成 docx，并输出到 outputs/notes.docx" --mode worker
python app.py --agent-task "帮我把2025年各家车企的销量，写入 xlsx 输出 outputs/report.xlsx" --mode worker
